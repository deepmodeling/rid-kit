...
def make_plumed (OUT,
                ...
                pstride = 5,
                pfile = "plm.out"):
    ret = general_plumed(TASK, CONF, JSON, kappa=kappa, temp=temp, tau=tau, gamma=gamma, pstride=pstride, pfile=pfile)
...
if __name__ == '__main__':
    ...
    TASK = "dpbias"
    general_plumed (TASK,CONF,JSON,kappa = 500.0,temp = 3000.0, tau = 10.0, gamma = 0.1, pstride = 5, pfile = "plm.out")
