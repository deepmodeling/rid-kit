...
def run_train (iter_index, 
    ...
    train_submission = Submission(work_base=train_path, machine=machine, resources=resources, task_list=train_task)
    ...
    freez_submission = Submission(work_base=train_path, machine=machine, resources=resources, task_list=freez_task)
