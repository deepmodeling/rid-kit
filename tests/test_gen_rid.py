...
class TestMakeRid(unittest.TestCase):
    ...
    def test_gen_rid(self):
        ...
        ridkit.gen_rid.gen_rid(out_dir=self.test_rid_out, mol_dir=self.benchmark_mol_dir, rid_json=self.json_file)
    ...
    def test_gen_rid_existed(self):
        ...
        ridkit.gen_rid.gen_rid(out_dir=self.test_rid_out_exists, mol_dir=self.benchmark_mol_dir, rid_json=self.json_file)
        self.assertTrue(os.path.exists(self.test_rid_out))
    ...
    def test_gen_rid_not_enough_conf(self):
        ...
        with self.assertRaises(AssertionError):
            ridkit.gen_rid.gen_rid(out_dir=self.test_rid_not_enough, mol_dir=self.benchmark_mol_dir, rid_json=json_not_enough)
