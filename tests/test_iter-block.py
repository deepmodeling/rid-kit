...
class TestMockedIterBlock(unittest.TestCase):
    def setUp(self):
        ...
        self.numb_cluster_threshold = 3
        self.adjust_amplifier = 1.5
        self.max_selection = 10
        self.max_level_multiple = 8.0
        self.dt = 0.002
        self.tail = 0.9
        self.output_freq = 50
        self.slice_mode = "gmx"
        self.if_make_threshold = False
        self.data_out = "iter-block"
        self.block_tag = "iter-002"
    ...
    def test_exploration(self):
        iter_block_step = Step(
            ...
            parameters = {
                ...
                "init_trust_lvl_1" : self.trust_lvl_1,
                "init_trust_lvl_2": self.trust_lvl_2,
                "exploration_config" : self.exploration_config,
                "cv_config" : self.cv_config,
                "cluster_threshold": self.cluster_threshold,
                "angular_mask": self.angular_mask,
                "weights": self.weights,
                "numb_cluster_threshold": self.numb_cluster_threshold,
                ...
                "max_level_multiple": self.max_level_multiple
            },
            artifacts = {
                "models" : None,
                "forcefield": None,
        ...
        wf = Workflow(name="iter-block-test", host=default_host)
        wf.add(iter_block_step)
        wf.submit()
